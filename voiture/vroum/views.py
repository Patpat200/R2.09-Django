...
def index(request):
    ...
    return render(request, "vroum/index.html", {"Marque": Marque, "Modele": Modele})
...
def ajout(request):
    if request.method == "POST": # arrive en cas de retour sur cette page après une
        ...
        if form.is_valid(): # validation du formulaire.
            ...
            return render(request,"vroum/marque/affiche.html",{"Marque" : Marque}) #

        else:
            return render(request,"vroum/marque/ajout.html",{"form": form})
    else :
...
def traitement(request):
    ...
    if lform.is_valid():
        ...
        return render(request,"vroum/marque/ajout.html",{"form": lform})
...
def all(request):
    Marque = list(models.Marque.objects.all())
    return render(request, "vroum/marque/all.html", {"Marque": Marque})
...
def traitementupdate(request, id):
    ...
    if request.method == "POST":
        ...
        if lform.is_valid():
            ...
            return render(request, "vroum/marque/update.html", {"form": lform, "id": id})
    else:
...
def ajoutmodele(request):
    if request.method == "POST": # arrive en cas de retour sur cette page après une
        ...
        if form.is_valid(): # validation du formulaire.
            ...
            return render(request,"vroum/modele/affichemodele.html",{"Modele" : Modele}) #

        else:
            return render(request,"vroum/modele/ajoutmodele.html",{"form": form})
    else :
...
def traitementmodele(request):
    ...
    if lform.is_valid():
        ...
        return render(request,"vroum/modele/ajoutmodele.html",{"form": lform})
...
def allmodele(request):
    Modele = list(models.Modele.objects.all())
    return render(request, "vroum/modele/allmodele.html", {"Modele": Modele})
...
def updatemodele(request, id):
    ...
    if request.method == "POST":
        ...
        if lform.is_valid():
            ...
            return render(request, "vroum/modele/updatemodele.html", {"form": lform, "id": id})
    else:
